...
type InteractiveMatchItem = FunctionReturnType<
  typeof api.functions.interactive_matches.list
>['items'][number];
interface InteractiveMatchGridProps {
  data: InteractiveMatchItem[] | undefined;
  isLoading: boolean;
  pagination:
    | FunctionReturnType<typeof api.functions.interactive_matches.list>
    | undefined;
  onPageChange: (page: number) => void;
  onDelete: (id: Id<'interactive_matches'>) => void;
}
...
export function InteractiveMatchGrid({
  ...
  const [matchToDelete, setMatchToDelete] =
    useState<Id<'interactive_matches'> | null>(null);
  ...
  const openDeleteDialog = (id: Id<'interactive_matches'>) => {
    setMatchToDelete(id);
